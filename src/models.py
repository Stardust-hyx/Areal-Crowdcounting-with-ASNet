...
class Model(nn.Module):
    ...
    def forward(self, im_data):
        with torch.no_grad():
            ...
            resized_foreground_mask = functional.interpolate(foreground_mask, scale_factor=8.0, mode='nearest')
            ...
            if dilate_size > 1:
                ...
                dilated_masks = None
                filters = torch.ones(1, 1, dilate_size, dilate_size)
                if self.is_cuda:
        ...
        return density_map, foreground_mask